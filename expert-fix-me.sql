...
('G025', 'Terasa berat ketika mengakses data dari komputer lain', 0),
('G026', 'Komputer mengalami blue screen', 1),
('G027', 'Munculnya blue screen dengan pesan pada bagian storage', 0),
...
('S001', 'Gunakan stabilizer atau UPS untuk menstabilkan tegangan listrik. Periksa semua koneksi kabel power supply. Terdapat beberapa kabel koneksi yang berasal dari power supply dan memiliki fungsi yang berbeda-beda. Pastikan semua kabel terpasang dengan benar dan tidak ada yang longgar. Hal ini dilakukan untuk memastikan pasokan daya listrik bekerja secara optimal. Apabila semua kabel sudah terpasang dengan benar dan masih mati total maka perlu diganti dengan yang baru.'),
...
('S009', 'Buka cover CPU lalu cabut RAM. Coba bersihkan bagian kaki RAM (pin) dengan penghapus dan pasang RAM kembali pada tempatnya dan nyalakan kembali Komputer. jika belum bisa, pindahkan RAM di slot lain. Jika masih belum bisa juga, maka RAM perlu diganti atau cek di komputer lain'),
...
('S015', 'Apabila Windows sudah diinstall ulang atau OS masih dalam keadaan baik-baik saja maka kemungkinan terjadi harddisk bad sector. Pada Safe Mode lakukan scan disk dengan cara Klik start Program - Program - Accessories - System Tools lalu pilih Scan disk. Atau bisa juga dengan cara Klik start Program - Search program and file - ketik cmd. Nanti akan masuk ke mode dos lalu ketik CHKDSK - Enter. Biarkan sistem bekerja sampai selesai lalu restart komputer.'),
...
('S019', 'Lakukan install ulang Windows. Jika masih belum bisa, bongkar baterai CMOS. Dengan cara ini kamu dapat mereset BIOS secara otomatis. Cabutlah CMOS pada perangkat lalu masukkan kembali saat kondisi komputer sudah menyala.'),
('S020', 'Cek daya yang ada pada Power Supply. Apabila dayanya lebih kecil dari yang tertera pada Power Supply maka Power Supply harus diganti.'),
...
('S026', 'Apabila harddisk bekerja normal namun hanya mengeluarkan suara terus menerus dan mengganggu bisa dengan melakukan Defrag Harddisk menggunakan Software Disk Defrag. Apabila harddisk berbunyi click lalu diam sejenak dan harddisk tidak dapat di akses, kemungkinan 50:50 harddisk bisa diperbaiki atau memang sudah rusak. Buka unit harddisk dari Komputer lalu masukkan ke tas kantong static kemudian tutup rapat lalu masukkan ke kulkas. Biarkan sekitar 20 menit sampai 1 jam di ruang pembuat es. Setelah itu keluarkan dari kulkas dan dikeringkan dari embun air. Kemudian nyalakan kembali pada Komputer. Head harddisk yang terkunci bisa kembali bekerja. Bila menemukan masalah seperti ini secepatnya back up data bila harddisk masih bisa membaca data'),
('S027', 'Periksa refresh rate vertikal monitor Anda. Pertama klik tombol Start - kemudian klik Run - Lalu Ketikkan control kemudian klik tombol OK. Carilah ikon berlabel Display dan klik dua kali. Pada jendela Display Properties klik tab Settings - Kemudian Klik tombol Advanced dan kemudian klik tab monitor. Di bawah bagian Monitor settings Anda akan melihat menu dropdown berlabel Screen refresh rate, dan pastikan bahwa refresh rate layar 75Hz atau lebih. Jika sudah silahkan merestart ulang komputer agar pengaturan baru ini bisa bekerja. Langkah kedua bisa dengan memperbarui Driver VGA Card. Langkah terakhir apabila masih belum bisa juga adalah melakukan service monitor di tempat service'),
...
('S030', 'Lakukan scan hardware menggunakan device manager : Klik Start - klik Run - Ketik \"devmgmt.msc\" dan kemudian klik OK. Device Manager akan terbuka. Pada Device Manager klik pada Computer. Klik pada Scan for hardware changes. Check USB device apakah sudah berfungsi sekarang. Langkah kedua bisa dengan melakukan restart komputer. Langkah kedua Disable and re-enable USB controller melalui device manager dan restart komputer (otomatis komputer akan melakukan scan hardware dan reinstall semua USB Controller.'),
